...
\begin{figure}[!htbp]
    ...
    \bicaption[Q判据等值面图，同时测试短标题]{Q判据等值面图，同时测试一下一个很长的标题，比如这真的是一个很长很长很长很长很长很长很长很长的标题。}[Isocontour of Q criteria, also testing short caption]{Isocontour of Q criteria, at the same time, this is to test a long title, for instance, this is a really very long very long very long very long very long title.}
    \label{fig:c06h06}
\end{figure}
...
\begin{enumerate}
    ...
    \item 文档内字体切换方法：
        \begin{itemize}
            ...
            \item 粗楷体：{\bfseries \kaishu{国科大论文模板} \textit{ucasthesis}} 或 \kaishu{\bfseries 国科大论文模板} \textit{\bfseries ucasthesis}
        \end{itemize}
\end{enumerate}
