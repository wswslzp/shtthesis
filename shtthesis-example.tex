...
\begin{figure}[htb]
  ...
  \caption[上海科技大学校徽]{上海科技大学校徽，\emph{这部分内容不会出现在图形列表的图题中}。}
\end{figure}
...
\begin{table}[htb]
  \centering
  \caption[一个普通的表格]{一个普通的表格，\emph{这部分内容同样不会出现在表格列表的表题中}。}
  \begin{tabular}{lcc}
    \hline
    项目 & 数值 1 & 数值 2 \\
    \hline
...
\section{测试参考文献}
测试 \verb|\citet|：\citet{wikibook2014latex}，\citet{lamport1986document, chen2005zhulu}。
