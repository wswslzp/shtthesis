...
\ProvideDocumentCommand{\chsfonttest}{%
  ...
  \IfFontExistsTF{#2}{%
    ...
    \begingroup%
      \zihao{5}\linespread{1.3}\testfont\par\textbf{#3}\hspace*{1\ccwd}\chsteststr%
    \endgroup%
  }{}
}
\ExplSyntaxOff
...
\chsfonttest[Songti SC Bold]{Songti SC Regular}{华文宋体}
\chsfonttest{FZShuSong-Z01}{方正书宋}
\chsfonttest[* Bold]{Noto Serif CJK SC}{思源宋体}
...
\begin{tabular}{ll}
  ...
  \engfonttest[STIX2Text-Bold.otf]{STIX2Text-Regular.otf}{STIX Two}
...
\subsection{Fira Math (Sans Serif)}
\setmathfont{FiraMath-Regular.otf}[StylisticSet=1, version=Fira]
\begingroup
  \mathversion{Fira}
  \mathtest
\endgroup
