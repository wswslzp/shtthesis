...
\chapter{模板使用}
\section{模板安装}
\shtthesis 提供的文档类型文件为 \verb|shtthesis.cls|，封面所需的上海科技大学校徽文件为 \verb|shanghaitech-logo.pdf|，参考文献 GBT-7714 格式文件为 \verb|gbt7714-plain.bst|，用户仅需将这三个文件拷贝至自己论文的工作目录下即可完成安装。假设用户的论文文件为 \verb|thesis.tex|，则工作目录中必要的文件包括：
\begin{center}
  \begin{tabular}{ll}
    \toprule
    文件名称 & 说明 \\
    ...
    \verb|gbt7714-plain.bst| & 参考文献格式文件 \\
